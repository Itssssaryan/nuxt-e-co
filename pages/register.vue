<template>
    <div>
        <section>
            <v-container>
                <h1>Register</h1>
                <v-row class="py-6" v-if="authStore.loading == false">
                    <v-col cols="12" md="6">
                        <v-text-field label="Enter your name" v-model="userData.name" clearable></v-text-field>
                    </v-col>
                    <v-col cols="12" md="6">
                ...
                <v-btn @click="authStore.register(userData)">
                    Register
                </v-btn>
            </v-container>
        </section>
